...
import { 
  ...
  Users, Sliders, BarChart2, User, Mail, Mic, Radio, Activity, Vote, Link, Lock, LayoutGrid, Video, Bot
} from 'lucide-react';
...
const ICON_MAP: Record<string, any> = {
  ...
  Sliders, BarChart2, User, Mail, Mic, Radio, Vote, Link, Activity, Video, Bot, Grid: LayoutGrid
};
